...
const news = [
  ...
  {
    id: 2,
    title: 'KCIS與香港科技大學展開技術合作',
    category: '合作夥伴',
    date: '2025-07-15',
    summary: 'KCIS與香港科技大學簽署合作協議，共同推進建築技術創新研究。',
    content: 'KCIS與香港科技大學工程學院正式簽署合作協議，雙方將在建築技術創新領域展開深入合作。此次合作將結合KCIS的行業實踐經驗和香港科技大學的學術研究優勢，共同推進建築技術的創新發展，培養相關領域的人才。',
    image: '/placeholder-news.jpg',
    tags: ['合作', '教育', '技術研發']
  },
  {
  ...
  {
    id: 6,
    title: 'KCIS參加2025香港建築技術展',
    category: '活動新聞',
    date: '2025-03-10',
    summary: 'KCIS亮相2025香港建築技術展，展示最新解決方案。',
    content: 'KCIS作為行業領先企業參加了2025香港建築技術展，展示了公司最新的智能建築解決方案和技術成果。展會期間，KCIS的展台吸引了眾多參觀者的關注，公司代表還應邀在技術論壇上發表演講，分享了對行業發展趨勢的見解。',
    image: '/placeholder-news.jpg',
    tags: ['展會', '技術展示', '行業活動']
  }
]
